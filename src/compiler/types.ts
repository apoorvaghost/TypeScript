namespace ts {
    ...
    export interface SymbolDisplayBuilder {
        ...
        buildSymbolDisplay(symbol: Symbol, writer: SymbolWriter, enclosingDeclaration?: Node, meaning?: SymbolFlags, flags?: SymbolFormatFlags, typeFlags?: TypeFormatFlags): void;
    ...
    export const enum TypeFormatFlags {
        ...
        UseTypeOfFunction               = 1 << 1,  // Write typeof instead of function type literal
        NoTruncation                    = 1 << 2,  // Don't truncate typeToString result
        ...
        InElementType                   = 1 << 6,  // Writing an array or union element type
        UseFullyQualifiedType           = 1 << 7,  // Write out the fully qualified type name (eg. Module.Type, instead of Type)
        InFirstTypeArgument             = 1 << 8,  // Writing first type argument of the instantiated type
        InTypeAlias                     = 1 << 9,  // Writing type in type alias declaration
        UseTypeAliasValue               = 1 << 10, // Serialize the type instead of using type-alias. This is needed when we emit declaration file.
        SuppressAnyReturnType           = 1 << 11, // If the return type is any-like, don't offer a return type.
        AddUndefined                    = 1 << 12, // Add undefined to types of initialized, non-optional parameters
        SuperSimple                     = 1 << 13, // Make all types super simple
    }
